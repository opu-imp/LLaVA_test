...
if __name__ == "__main__":
    ...
    parser.add_argument("--json_path", type=str, default="dataset/2023/rebuild_labels")
    parser.add_argument(
        "--saved_dir", type=str, default="./outputs/new_species_dataset/2023/test2/"
    )
    ...
    for i, chunk in tqdm(enumerate(chunks)):
        ...
        for j, filename in enumerate(chunk):
            ...
            correct_rate_results.append(correct_rate_list)
            ...
            json.dump(
                {
                    ...
                    "correct_rate": correct_rate_results,
